...
// *****************************************************************************
typedef enum {
    ERR_CODE_SST26_NO_ERROR = 0,
    ERR_CODE_SST26,
    ERR_CODE_SST26_GEOMETRY,
    ERR_CODE_SST26_ERASE,
    ERR_CODE_SST26_WRITE,
    ERR_CODE_SST26_READ,
    ERR_CODE_SST26_JEDECID,
    ERR_CODE_SSD_WRITE,
    ERR_CODE_SSD_READ,
} APP_CONSOLE_ERR_CODE;
...
{
    APP_CONSOLE_INIT = 0,
    APP_CONSOLE_SST26_OPEN,
    APP_CONSOLE_SST26_JDEC,
    APP_CONSOLE_SST26_WRITE,
    APP_CONSOLE_SST26_READ,
    APP_CONSOLE_SSD_WRITE,
    APP_CONSOLE_SSD_READ,
    APP_CONSOLE_RUNNING,
    APP_CONSOLE_ERROR
...
typedef struct
{
    ...
    APP_CONSOLE_ERR_CODE error;

    SYS_TIME_HANDLE timer;
    bool timerExpired;

    DRV_HANDLE sst26Handler;
    DRV_SST26_GEOMETRY sst26Geometry;
    uint32_t sst26Address;
    size_t sst26Length;
