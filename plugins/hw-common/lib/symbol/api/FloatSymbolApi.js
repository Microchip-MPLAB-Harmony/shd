...
class FloatSymbolApi extends ConfigSymbolApi_1.default {
    constructor(path) {
        ...
        this.getFloatSymbol = (componentId, symbolId) => __awaiter(this, void 0, void 0, function* () {
            const response = yield Transceiver_1.transceiver.send({
                path: this.path,
...
exports.floatSymbolApi = new FloatSymbolApi();
exports.default = FloatSymbolApi;
