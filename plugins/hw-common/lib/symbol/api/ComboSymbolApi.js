...
class ComboSymbolApi extends ConfigSymbolApi_1.default {
    constructor(path) {
        ...
        this.getOptions = (componentId, symbolId) => __awaiter(this, void 0, void 0, function* () {
            const response = yield Transceiver_1.transceiver.send({
                path: this.path,
                method: 'getOptions',
                data: {
        ...
        this.getComboSymbol = (componentId, symbolId) => __awaiter(this, void 0, void 0, function* () {
            const response = yield Transceiver_1.transceiver.send({
                path: this.path,
...
exports.comboSymbolApi = new ComboSymbolApi();
exports.default = ComboSymbolApi;
