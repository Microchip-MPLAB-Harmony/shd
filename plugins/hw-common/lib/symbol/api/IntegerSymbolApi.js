...
class IntegerSymbolApi extends ConfigSymbolApi_1.default {
    constructor(path) {
        ...
        this.getIntegerSymbol = (componentId, symbolId) => __awaiter(this, void 0, void 0, function* () {
            const response = yield Transceiver_1.transceiver.send({
                path: this.path,
...
exports.integerSymbolApi = new IntegerSymbolApi();
exports.default = IntegerSymbolApi;
