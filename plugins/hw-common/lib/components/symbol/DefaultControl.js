...
const CommentLabelDefault_1 = __importDefault(require("./CommentLabelDefault"));
const DefaultControl = (props) => {
    ...
    switch (symbolType) {
        ...
        case 'CommentSymbol': {
            return ((0, jsx_runtime_1.jsx)(CommentLabelDefault_1.default, { componentId: componentId, symbolId: symbolId, className: props.className }));
        }
        case 'ComboSymbol': {
        ...
        default: {
            return (0, jsx_runtime_1.jsxs)("div", { children: ["Default Control Not Available for the symbol Type ", symbolType] });
        }
    }
};
