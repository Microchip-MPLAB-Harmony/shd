...
// class EventSynchronizerContainer {
//   private syncValues: { symbolId: string; syncValue: any }[] = [];
...
//   constructor(private _valuesBackup: { symbolId: string; syncValue: any }[]) {}

//   getValueBackup(symbolId: string): any {
//     return this._valuesBackup;
//   }
